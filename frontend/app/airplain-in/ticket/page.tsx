...
const TicketDetailsPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchTicket = async () => {
            try {
                const res = await fetch(`http://${HOST}:${PORT}/api/flight/tickets/?serial=${serial}`);
                const vehicleRes = await fetch(`http://${HOST}:${PORT}/api/flight/travels/?serial=${serial}`);
    ...
    const handleDownloadTicket = async () => {
        ...
        try {
            ...
            const res = await fetch(`http://${HOST}:${PORT}/api/flight/tickets/print/`, {
                method: 'POST',
                body: formData,
            });
