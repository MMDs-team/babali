    ...
    return (
        <main className="mt-15 w-full">
            <div className="w-full">
                <ul className="flex px-12 md:px-18 lg:px-26 xl:px-42  py-8 text-gray-400 text-sm">
                    <li className="passed pr-4 flex-1 flex flex-col items-center">
                        <span className="flex bg-white md:pb-1 md:px-1">
                            <svg viewBox="0 0 24 24" width="26px" height="26px" fill="currentColor" className="a-steppers__icon text-success-400">
                        ...
                        <span className="a-steppers__title">انتخاب اتوبوس</span>
                        
                    </li>
                    <li className="active text-success-500 flex-1 flex flex-col items-center">
                        ...
                        <span className="a-steppers__title">مشخصات مسافران</span>
                        
                    </li>
                    <li className=" flex-1 flex flex-col items-center">
                        <span className="flex bg-white md:pb-1 md:px-1">
                            <svg viewBox="0 0 24 24" width="26px" height="26px" fill="currentColor" className="a-steppers__icon text-grays-200">
                        ...
                        <span className="a-steppers__title">تایید اطلاعات</span>
                    ...
                    <li className=" flex-1 flex flex-col items-center">
                        ...
                        <span className="a-steppers__title">پرداخت</span>
                    ...
                    <li className="pl-4 flex-1 flex flex-col items-center">
                        ...
                        <span className="a-steppers__title">صدور بلیط</span>
