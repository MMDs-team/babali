...
export default function TicketDetailsPage() {
    ...
    useEffect(() => {
        ...
        const fetchTicket = async () => {
            try {
                ...
                const vehicleRes = await fetch(`${API_URL_BACKEND}/bus/travels/?serial=${serial}`);
    ...
    const handleDownloadTicket = async () => {
        ...
        try {
            ...
            const pdfPath = await fetch(`${API_URL_BACKEND}/bus/tickets/print/`, {
                method: 'POST',
                body: formData,
            });
                ...
                <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-xs p-6">
                    ...
                    <div className="flex justify-center gap-4 mt-6">
                        ...
                        <button
                            ...
                            onClick={() => router.push('/bus-ticket')}
                        >
                            بازگشت
                        </button>
                    </div>
