...
const BACKEND_HOST = process.env.NEXT_PUBLIC_TRAIN_HOST || 'localhost';
...
const TicketDetailsPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchTicket = async () => {
            try {
                const res = await fetch(`http://${BACKEND_HOST}:${BACKEND_PORT}/api/train/tickets/?serial=${serial}`);
                const vehicleRes = await fetch(`http://${BACKEND_HOST}:${BACKEND_PORT}/api/train/travels/?serial=${serial}`);
